...
- **Nodes**: Include role/purpose, not just name
- **Arrows**: Label what flows or happens, not that a relationship exists
...
|-----------|-----|---------------|
| Work-in-progress | Spec is for current truth | Design docs/plan files |
